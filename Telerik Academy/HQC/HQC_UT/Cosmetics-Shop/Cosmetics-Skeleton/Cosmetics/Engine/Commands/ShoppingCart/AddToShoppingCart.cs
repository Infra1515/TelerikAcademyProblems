...
{
    public class AddToShoppingCart : ICommand
    {
        private readonly IDataStore dataStore;

        public AddToShoppingCart(IDataStore dataStore)
        {
        ...
        public string Execute(IList<string> commandParameters)
        {
            ...
            {
                return string.Format(Constants.ProductDoesNotExist, productToRemoveFromCart);
            }
